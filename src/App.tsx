    ...
    <AuthProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/student/assignments" element={<Navigate to="/student/submissions" replace />} />
          <Route path="/student/monthly-logs" element={<Navigate to="/student/submissions" replace />} />
